...
$route['produk-terbaru/(:any)/detil'] = 'item/get_with_produkterbaru/$1';
$route['produk-terbaru/(:any)/add_to_cart'] = 'cart/add';
$route['hot-item/(:any)/detil'] = 'item/get_with_hotitem/$1';
$route['hot-item/(:any)/add_to_cart'] = 'cart/add/$1';
$route['item/(:any)/detil'] = 'item/get/$1';
$route['item/(:any)/add_to_cart'] = 'cart/add/$1';
$route['kategori/(:any)'] = 'kategori/get_item/$1';
$route['kategori/(:any)/(:any)/detil'] = 'item/get_with_kategori/$1/$2';
$route['kategori/(:any)/(:any)/add_to_cart'] = 'cart/add';
