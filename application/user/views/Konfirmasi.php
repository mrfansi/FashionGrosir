            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card r-posisi-kartu mb-3 container-fluid">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="r-container-konten">
                                            <input type="text" class="form-control r-style-input f-border-form" id="id_order">
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="r-upload-f-button-font-wrapper">
                                        <button class="r-btn"><i class="fa fa-upload" style="font-size: 18px;"></i>Unggah File</button>
                        ...
                        <a href="form_pengiriman.html" class="btn btn-primary btn-lg mb-3 btn-block col-2 f-button-font">Konfirmasi</a>
