        ...
        <div class="row">
            <?php if (isset($item) && $item != NULL): ?>
                ...
                <form action="add_to_cart" method="post" class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p><i class="fa fa-check f-icon-margin f-font-detail"></i>Kondisi : Baru</p>
                            <p><i class="fa fa-cube f-icon-margin f-font-detail"></i>Berat
                                : <?= $item->i_berat; ?> Gram</p>
                            <p><i class="fas fa-box-open fa-1x f-icon-margin f-font-detail"></i>Min.. Pesanan : 1pcs</p>
                        </div>
                    </div>
                    <div class="row">
