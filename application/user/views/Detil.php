        ...
        <div class="row">
            <?php if (isset($item) && $item != NULL): ?>
                ...
                <form action="add_to_cart" method="post" class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p><i class="fa fa-check fa-lg f-icon-margin f-font-detail mr-2"></i>Kondisi : Baru</p>
                            <p><i class="fa fa-cube fa-lg f-icon-margin f-font-detail mr-2"></i>Berat
                                : <?= $item->i_berat; ?> Gram</p>
                            <p><i class="fa fa-dropbox fa-lg f-icon-margin f-font-detail mr-2"></i>Min. Pesanan : 1pcs</p>
                        </div>
                    </div>
                    <div class="row">
