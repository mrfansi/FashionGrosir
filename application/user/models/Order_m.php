...
class Order_m extends MY_Model
{
    ...
    {
        $query = $this->db->query("SELECT orders.o_kode, orders.created_at, orders.o_noorder, orders.o_status, orders.o_deskripsi, pengguna.p_nama, SUM(orders_detil.od_tharga) total
                                    FROM orders
                                    INNER JOIN pengguna
