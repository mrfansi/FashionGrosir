            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a tooltip data-toggle="modal" title="Tambah <?= $title_page; ?>" href="#" onclick="tambah()" data-target="#crud" class="btn btn-sm btn-primary btn-block"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                                ...
                                <?php foreach ($kategoris as $kategori): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a tooltip data-toggle="modal" title="Ubah User" href="#" onclick="edit($(this))" data-target="#crud" data-id="<?= $kategori->k_kode; ?>"><i class="far fa-edit"></i></a> |
                                            <a tooltip data-toggle="modal" title="Hapus User" href="#" onclick="hapus($(this))" data-target="#hapus" data-id="<?= $kategori->k_kode; ?>"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
