...
<head>
    ...
    <title ng-bind="judul_web">Loading...</title>
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li><a href="#itemsdown" aria-expanded="false" data-toggle="collapse" ng-click="list_kategories()"> <i
                    ...
                    <ul id="itemsdown" class="collapse list-unstyled">
                        <li><a href="#!/item?create_new"> <i class="fa fa-plus"></i> BUAT
                                KATEGORI</a></li>
                        <li><a href="#!/item?kat=all">ALL</a></li>
                        <li ng-repeat="kategori in kategories">
                            <a href="#!/item?kat={{kategori.kat_kode}}">{{kategori.kat_nama}}</a>
                        </li>
                    </ul>
                </li>
                <li><a href="#transaksidown" aria-expanded="false" data-toggle="collapse"> <i
                    ...
                    <ul id="transaksidown" class="collapse list-unstyled">
                        ...
                        <li>
                            <a href="#!/transaksi?invoice">INVOICE</a>
                        </li>
                        <li>
                            <a href="#!/transaksi?pembayaran">PEMBAYARAN</a>
                        </li>
                    </ul>
                </li>
